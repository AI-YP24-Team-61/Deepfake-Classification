...
models_fitted = {}
# Пространство инстансов моделей (хотел поместить их в models_fitted,
# но т.к. models_fitted помещается в response,
# то 'class type' (CustomModel) не сериализуется в JSON)
models_classes = {}
